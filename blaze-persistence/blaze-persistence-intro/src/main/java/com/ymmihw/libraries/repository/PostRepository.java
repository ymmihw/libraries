package com.ymmihw.libraries.repository;
...
public class PostRepository {
  ...
  public Iterable<PostWithAuthorView> findBy(final String title, final String authorName) {
    CriteriaBuilder<Post> postCriteriaBuilder =
        builderFactory
            .create(entityManager, Post.class, "p")
            .whereOr()
            .where("p.title")
            .like()
            .value(title + "%")
    ...
    CriteriaBuilder<PostWithAuthorView> postWithAuthorViewCriteriaBuilder =
        viewManager.applySetting(
            EntityViewSetting.create(PostWithAuthorView.class), postCriteriaBuilder);

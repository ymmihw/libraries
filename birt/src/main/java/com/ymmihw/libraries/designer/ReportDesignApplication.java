package com.ymmihw.libraries.designer;
...
public class ReportDesignApplication implements CommandLineRunner {
  ...
  private static final Logger log = LoggerFactory.getLogger(ReportDesignApplication.class);

  @Value("${reports.relative.path}")
  private String REPORTS_FOLDER;

  public static void main(String[] args) {
    new SpringApplicationBuilder(ReportDesignApplication.class).web(WebApplicationType.NONE).build()
        .run(args);
  }

package com.ymmihw.libraries.engine.service;
...
public class BirtReportService implements ApplicationContextAware, DisposableBean {
  ...
  public List<Report> getReports() {
    ...
    for (Map.Entry<String, IReportRunnable> entry : reports.entrySet()) {
      ...
      Report reportItem =
          new Report(report.getDesignHandle().getProperty("title").toString(), entry.getKey());
  ...
  private void generateHTMLReport(IReportRunnable report, HttpServletResponse response,
    ...
    runAndRenderTask.getAppContext().put(EngineConstants.APPCONTEXT_BIRT_VIEWER_HTTPSERVET_REQUEST,
        request);

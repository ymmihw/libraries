...
import com.ymmihw.libraries.okhttp.sampleapp.web.dto.Foo;
...
public class UserController {
  ...
  public String uploadFile(@RequestParam final String username, @RequestParam final String password,

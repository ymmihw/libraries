...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AvroHttpRequest fromByteBuffer(
   ...
   private com.ymmihw.libraries.avro.ClientIdentifier clientIdentifier;
   private java.util.List<java.lang.CharSequence> employeeNames;
   private com.ymmihw.libraries.avro.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.ymmihw.libraries.avro.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.ymmihw.libraries.avro.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.ymmihw.libraries.avro.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.ymmihw.libraries.avro.Active)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.ymmihw.libraries.avro.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.ymmihw.libraries.avro.ClientIdentifier value) {
   ...
   */
  public com.ymmihw.libraries.avro.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.ymmihw.libraries.avro.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.ymmihw.libraries.avro.AvroHttpRequest.Builder newBuilder() {
    return new com.ymmihw.libraries.avro.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.ymmihw.libraries.avro.AvroHttpRequest.Builder newBuilder(com.ymmihw.libraries.avro.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new com.ymmihw.libraries.avro.AvroHttpRequest.Builder();
    } else {
      return new com.ymmihw.libraries.avro.AvroHttpRequest.Builder(other);
    }
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.ymmihw.libraries.avro.AvroHttpRequest.Builder newBuilder(com.ymmihw.libraries.avro.AvroHttpRequest other) {
    if (other == null) {
      return new com.ymmihw.libraries.avro.AvroHttpRequest.Builder();
    } else {
      return new com.ymmihw.libraries.avro.AvroHttpRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private long requestTime;
    private com.ymmihw.libraries.avro.ClientIdentifier clientIdentifier;
    private com.ymmihw.libraries.avro.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.ymmihw.libraries.avro.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ymmihw.libraries.avro.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.ymmihw.libraries.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ymmihw.libraries.avro.AvroHttpRequest other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder setClientIdentifier(com.ymmihw.libraries.avro.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.ymmihw.libraries.avro.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.ymmihw.libraries.avro.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.ymmihw.libraries.avro.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(com.ymmihw.libraries.avro.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder setActive(com.ymmihw.libraries.avro.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ymmihw.libraries.avro.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.ymmihw.libraries.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.ymmihw.libraries.avro.Active) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.clientIdentifier == null) {
        this.clientIdentifier = new com.ymmihw.libraries.avro.ClientIdentifier();
      }
      ...
      this.active = com.ymmihw.libraries.avro.Active.values()[in.readEnum()];

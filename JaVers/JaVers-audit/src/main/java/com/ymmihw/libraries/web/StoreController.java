...
import com.ymmihw.libraries.service.StoreService;
...
public class StoreController {
  ...
  public void rebrandStore(@PathVariable final Integer storeId,
      @RequestBody RebrandStoreDto rebrandStoreDto) {
    storeService.rebrandStore(storeId, rebrandStoreDto.name);
  }

  @PostMapping(value = "/stores/{storeId}/products/{productId}/price",
      consumes = MediaType.APPLICATION_JSON_VALUE)
  public void updateProductPrice(@PathVariable final Integer productId,
      @PathVariable String storeId, @RequestBody UpdatePriceDto priceDto) {
  ...
  public String getStoreShadows(@PathVariable int storeId) {
    ...
    JqlQuery jqlQuery = QueryBuilder.byInstance(store).withChildValueObjects().build();

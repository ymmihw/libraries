...
public class NumbersBeanUnitTest {
  ...
  /**
   * Tests that when an even number is passed to {@link NumbersBean#isNumberEven(int)}, true is
   * returned.
   */
  @Test
  ...
  /**
   * Tests that when an odd number is passed to {@link NumbersBean#isNumberEven(int)}, false is
   * returned.
   */
  @Test

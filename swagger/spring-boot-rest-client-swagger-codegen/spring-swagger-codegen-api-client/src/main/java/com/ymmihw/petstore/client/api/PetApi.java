...
import com.ymmihw.petstore.client.model.ModelApiResponse;
import com.ymmihw.petstore.client.model.Pet;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen",
    date = "2018-09-14T13:19:35.382+08:00")
@Component("com.ymmihw.petstore.client.api.PetApi")
public class PetApi {
  ...
  public List<Pet> findPetsByStatus(List<String> status) throws RestClientException {
    ...
    queryParams.putAll(apiClient.parameterToMultiValueMap(
        ApiClient.CollectionFormat.valueOf("multi".toUpperCase()), "status", status));
  ...
  public List<Pet> findPetsByTags(List<String> tags) throws RestClientException {
    ...
    queryParams.putAll(apiClient.parameterToMultiValueMap(
        ApiClient.CollectionFormat.valueOf("multi".toUpperCase()), "tags", tags));
  ...
  public ModelApiResponse uploadFile(Long petId, String additionalMetadata, File file)
    ...
    final Map<String, Object> uriVariables = new HashMap<String, Object>();
    uriVariables.put("petId", petId);
    String path = UriComponentsBuilder.fromPath("/pet/{petId}/uploadImage")

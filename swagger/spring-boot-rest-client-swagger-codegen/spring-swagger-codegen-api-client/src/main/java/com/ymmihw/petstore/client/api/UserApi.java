package com.ymmihw.petstore.client.api;
...
import com.ymmihw.petstore.client.model.User;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen",
    date = "2018-09-14T13:19:35.382+08:00")
@Component("com.ymmihw.petstore.client.api.UserApi")
public class UserApi {
  ...
  public void createUser(User body) throws RestClientException {
    ...
    apiClient.invokeAPI(path, HttpMethod.POST, queryParams, postBody, headerParams, formParams,
   ...
   * <p>
   * <b>400</b> - Invalid username supplied
   * <p>
  ...
  public void deleteUser(String username) throws RestClientException {
    ...
    String path = UriComponentsBuilder.fromPath("/user/{username}").buildAndExpand(uriVariables)
        .toUriString();
    ...
    ParameterizedTypeReference<Void> returnType = new ParameterizedTypeReference<Void>() {};
    apiClient.invokeAPI(path, HttpMethod.DELETE, queryParams, postBody, headerParams, formParams,
        accept, contentType, authNames, returnType);
  }
  ...
  public User getUserByName(String username) throws RestClientException {
    ...
    return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams,
   ...
   * <b>200</b> - successful operation
   * <p>
   * <b>400</b> - Invalid username/password supplied
   * 
  ...
  public void logoutUser() throws RestClientException {
    ...
    ParameterizedTypeReference<Void> returnType = new ParameterizedTypeReference<Void>() {};
    apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams,
        accept, contentType, authNames, returnType);
  }
  ...
  public void updateUser(String username, User body) throws RestClientException {
    ...
    ParameterizedTypeReference<Void> returnType = new ParameterizedTypeReference<Void>() {};
    apiClient.invokeAPI(path, HttpMethod.PUT, queryParams, postBody, headerParams, formParams,
        accept, contentType, authNames, returnType);
  }
}

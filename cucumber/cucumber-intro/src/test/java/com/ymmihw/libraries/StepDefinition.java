...
public class StepDefinition {
  ...
  private final InputStream jsonInputStream =
      this.getClass().getClassLoader().getResourceAsStream("cucumber.json");
  private final String jsonString =
      new Scanner(jsonInputStream, "UTF-8").useDelimiter("\\Z").next();
  ...
  public void usersUploadDataOnAProject() throws IOException {
    ...
    stubFor(post(urlEqualTo(CREATE_PATH)).withHeader("content-type", equalTo(APPLICATION_JSON))
    ...
    verify(postRequestedFor(urlEqualTo(CREATE_PATH)).withHeader("content-type",
  ...
  public void usersGetInformationOnAProject(String projectName) throws IOException {
    ...
    verify(getRequestedFor(urlEqualTo("/projects/cucumber")).withHeader("accept",
        equalTo(APPLICATION_JSON)));

...
public class ActivitiControllerIntegrationTest {
  private static final Logger logger =
      LoggerFactory.getLogger(ActivitiControllerIntegrationTest.class);
  ...
  public void givenProcess_whenStartProcess_thenIncreaseInProcessInstanceCount() throws Exception {
    ...
    String responseBody =
        this.mockMvc
            ...
            .getContentAsString();
    assertEquals(
        "Process started. Number of currently running process instances = 1", responseBody);
    ...
    responseBody =
        this.mockMvc
            ...
            .getContentAsString();
    assertEquals(
        "Process started. Number of currently running process instances = 2", responseBody);
    ...
    responseBody =
        this.mockMvc
            ...
            .getContentAsString();
    assertEquals(
        "Process started. Number of currently running process instances = 3", responseBody);
  }
  ...
  public void givenProcess_whenProcessInstance_thenReceivedRunningTask() throws Exception {
    ...
    ProcessInstance pi =
        runtimeService.createProcessInstanceQuery().orderByProcessInstanceId().desc().list().get(0);
    ...
    List<TaskRepresentation> tasks =
        Arrays.asList(mapper.readValue(responseBody, TaskRepresentation[].class));
  ...
  public void givenProcess_whenCompleteTaskA_thenReceivedNextTask() throws Exception {
    ...
    logger.info("process instance = " + pi.getId());
    this.mockMvc
        .perform(MockMvcRequestBuilders.get("/complete-task-A/" + pi.getId()))
        .andReturn()
        .getResponse()
        .getContentAsString();

...
public class TinkUnitTest {
  ...
  @Test
  public void givenPlaintext_whenEncryptWithAead_thenPlaintextIsEncrypted()
  ...
  @Test
  public void givenPlaintext_whenEncryptWithHybridEncryption_thenVerifyDecryptedIsEqual()
      throws GeneralSecurityException {

    TinkConfig.register();

    KeysetHandle privateKeysetHandle = KeysetHandle
        .generateNew(HybridKeyTemplates.ECIES_P256_HKDF_HMAC_SHA256_AES128_CTR_HMAC_SHA256);

...
public class TransactionalService {
  ...
  public Integer getQuickHowManyVisits() {
    try {
      ...
      watch.stop();
      System.out.println("I was able to set HowManyVisits to " + howManyVisits + " after waiting "
  ...
  public void startBackgroundBatch() {
    try {
      ...
      System.out
          .println("HowManyVisits should now be 1000, " + "but we are holding the transaction");
      Thread.sleep(1000L);
      tm.rollback();

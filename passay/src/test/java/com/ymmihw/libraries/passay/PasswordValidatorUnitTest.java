...
public class PasswordValidatorUnitTest {
  ...
  public void givenPasswordValidatorWithLengthRule_whenValidation_thenTooShortPassword() {
    ...
    Integer lengthCount =
        validate.getMetadata().getCounts().get(RuleResultMetadata.CountCategory.Length);
  ...
  @Test
  public void givenPasswordValidatorWithLengthRule_whenValidation_thenCustomizedMeesagesAvailable()
      throws IOException {
    ...
    PasswordValidator validator =
        new PasswordValidator(resolver, new LengthRule(8, 16), new WhitespaceRule());

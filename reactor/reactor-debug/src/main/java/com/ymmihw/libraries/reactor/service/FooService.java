package com.ymmihw.libraries.reactor.service;

import static com.ymmihw.libraries.reactor.service.FooNameHelper.concatAndSubstringFooName;
import static com.ymmihw.libraries.reactor.service.FooNameHelper.substringFooName;
import static com.ymmihw.libraries.reactor.service.FooQuantityHelper.divideFooQuantity;
import static com.ymmihw.libraries.reactor.service.FooQuantityHelper.processFooReducingQuantity;
import static com.ymmihw.libraries.reactor.service.FooReporter.reportResult;
...
public class FooService {
  ...
  public void processUsingApproachFivePublishingToDifferentParallelThreads(Flux<Foo> flux) {
    ...
    flux.subscribeOn(Schedulers.newParallel("five-parallel-starter")).subscribe();
  }
  ...
  public void processUsingApproachFivePublishingToDifferentSingleThreads(Flux<Foo> flux) {
    ...
    flux = flux.log().subscribeOn(Schedulers.newSingle("five-single-starter"));
